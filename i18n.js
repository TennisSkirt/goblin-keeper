...
const I18N = {
  ko: {
    ...
    "f.pin": "카드 비밀번호",
    "f.memberNumber": "회원번호",
    "f.barcodeFormat": "바코드 형식",
    "f.bankName": "은행명",
    "f.bankCode": "은행 코드",
    "f.branchCode": "지점 코드",
    "f.accountType": "예금 종류",
    "f.accountNumber": "계좌번호",
    "f.accountHolder": "명의 (카나)",
    "f.ssid": "네트워크 이름",
    "f.wifiPassword": "비밀번호",
    "f.body": "내용",
    "f.idKind": "종류(주민등록증/여권 등)",
    "f.idNumber": "번호",
    "f.issued": "발급일",
    ...
    "reauth.ph": "암구호",
    "reauth.submit": "확인",
    "reauth.bioFail": "인증에 실패했어요. 암구호를 입력해주세요.",

    "picker.title": "어떤 것을 맡길까요?",
    "custom.section": "커스텀 필드",
    "custom.add": "필드 추가",
    "custom.labelPh": "라벨 (예: 복구코드)",
    "custom.valuePh": "값",
    "fav.label": "즐겨찾기",
    "filter.all": "전체",
    "filter.fav": "즐겨찾기",
    "warn.reuse": "비밀번호 재사용",
    "warn.reuseFull": "이 비밀번호를 {n}곳에서 재사용 중이에요.",
    "warn.expired": "만료됨",
    "warn.expirySoon": "곧 만료",
    "barcode.invalid": "이 형식으로 만들 수 없는 번호예요.",
    "barcode.hint": "매장에서 이 바코드를 스캔하세요",
    "bc.code128": "Code 128 (기본)",
    "bc.ean13": "EAN-13 (상품형)",
    "bc.code39": "Code 39",
  },
  ...
  ja: {
    ...
    "f.pin": "暗証番号",
    "f.memberNumber": "会員番号",
    "f.barcodeFormat": "バーコード形式",
    "f.bankName": "銀行名",
    "f.bankCode": "銀行コード",
    "f.branchCode": "支店コード",
    "f.accountType": "口座種別",
    "f.accountNumber": "口座番号",
    "f.accountHolder": "名義 (カナ)",
    "f.ssid": "ネットワーク名",
    "f.wifiPassword": "パスワード",
    "f.body": "内容",
    "f.idKind": "種類(免許・パスポート等)",
    "f.idNumber": "番号",
    "f.issued": "発行日",
    ...
    "reauth.ph": "合言葉",
    "reauth.submit": "確認",
    "reauth.bioFail": "認証に失敗しました。合言葉を入力してください。",

    "picker.title": "何を預けますか？",
    "custom.section": "カスタム項目",
    "custom.add": "項目を追加",
    "custom.labelPh": "ラベル（例: リカバリコード）",
    "custom.valuePh": "値",
    "fav.label": "お気に入り",
    "filter.all": "すべて",
    "filter.fav": "お気に入り",
    "warn.reuse": "パスワード使い回し",
    "warn.reuseFull": "このパスワードを{n}か所で使い回しています。",
    "warn.expired": "期限切れ",
    "warn.expirySoon": "まもなく期限切れ",
    "barcode.invalid": "この形式では生成できない番号です。",
    "barcode.hint": "店舗でこのバーコードをスキャン",
    "bc.code128": "Code 128 (標準)",
    "bc.ean13": "EAN-13 (商品用)",
    "bc.code39": "Code 39",
  },
};
